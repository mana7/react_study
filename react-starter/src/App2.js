...
//       */}
//       <button onClick={() => setCount(prevCount => prevCount + 2)}>click</button>
//     </div>
//   );
// }
...
// function Timer() {
//   // timeLeft という state と state を更新するsetTimeLeft 関数を定義。
...
/* 8 useCallback の利用例 */
//イベントの処理内容(関数)を変数に格納し、JSXに組み込みたい時に利用される
...
// 【注意】React.memo でコンポーネントを囲わないと、メモ化した関数を渡しても再描画されてしまう
